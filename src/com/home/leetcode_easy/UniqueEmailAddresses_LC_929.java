...
public class UniqueEmailAddresses_LC_929 {
    public int numUniqueEmails(String[] emails) {
        ...
        for (String email: emails) {
            ...
            String domainName = email.substring(atIndex);           //no need to provide end index here, it will take till end of the string
