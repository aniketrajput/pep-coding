...
Given an array of integers nums and an integer target, return indices of the two numbers such that they add up to target.
	...
	If it is not present in HashMap<Value, Index>, add nums[i] and i in HashMap. We are stroing elements we traversed in hashMap which might be one of the required pair number
...
public class TwoSum_LC_1 {
    ...
    /*public int[] twoSum(int[] nums, int target) {
        ...
        Arrays.sort(pairsArr);          //using Comaparable compareTo it will sort
